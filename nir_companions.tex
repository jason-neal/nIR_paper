...
% If you need two or more lines of authors, add an extra line using \newauthor
  \author[J. J. Neal et. al.]{
      J. J. Neal$^{1,2}$\thanks{\email{jason.neal@astro.up.pt}}
     P. Figueira$^{3,1}$ 
 N. C. Santos$^{1,2}$
    C. Melo$^{3}$
\\
