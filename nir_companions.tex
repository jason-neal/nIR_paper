...
{\bl The observations were gathered having in mind the application of a differential subtraction method~\citep[e.g.][]{ferluga_separating_1997, kostogryz_spectral_2013}. However with the small time separation of the observations and long orbital periods the spectral shift of the companions' lines result in an insufficient separation to detect the spectrum of the companion spectrum.
}
