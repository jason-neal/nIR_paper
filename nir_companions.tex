...
We discuss potential reasons and solutions for these poor results below, list the lessons learned in this exploratory study, and provide some guidance for any future attempts with these methods. {\rd We do note that there have been recent works, that have had successful detection of non-transiting giant planets, they use a different technique cross correlation and maximum likelyhood....} They are successful due to spectra with much higher SNR, longer wavelength range.    XXXXXXXXXXXXXXXXXXXXXXX
