...
% to follow the A&A style
\bibpunct{(}{)}{;}{a}{}{,}  % chkteX 9

\begin{document}

   \title{Towards the near-infrared detection of brown dwarf companions\thanks{Based on observations collected at the European Organisation for Astronomical Research in the Southern Hemisphere 
           under ESO programme 089.C-0977(A)}}
   \subtitle{Exploring methods to detect low mass stellar companions from blended spectra}
  
   \titlerunning{Towards the nIR detection of BD companions}
   \authorrunning{J.J. Neal et. al.}
   
   \author{J. J. Neal\inst{\ref{IA}, \ref{FCUP}}\thanks{\email{jason.neal@astro.up.pt}}
          \and P. Figueira\inst{\ref{ESO/Chile}, \ref{IA}} 
          \and N. C. Santos\inst{\ref{IA}, \ref{FCUP}}
          \and C. Melo\inst{\ref{ESO/Chile}}
          }

   \institute{Instituto de Astrof\'{\i}sica e Ci\^encias do Espa\c{c}o, CAUP, Universidade do Porto, Rua das Estrelas, PT4150-762 Porto, Portugal\label{IA}
            \and Departamento de F\'{\i}sica e Astronomia, Faculdade de Ci\^{e}ncias, Universidade do Porto, Portugal\label{FCUP}
            \and European Southern Observatory, Alonso de C\'{o}rdova 3107, Vitacura, Casilla 19001, Santiago 19, Chile\label{ESO/Chile}
            }
...
% conclusions heading (optional), leave it empty if necessary
 {This work highlights the challenges in the spectral detection of faint BD companions. We explore the limitations of the direct subtraction method in the case of small RV separation, and attempt companion recovery at low companion/host flux ratios below 3\%, finding a high upper mass limit from the technique.}
  ...
  \keywords{(stars:) binaries: spectroscopic -- (stars:) brown dwarfs -- Infrared: stars  -- techniques: spectroscopic -- methods: miscellaneous}
...
The work of \citet{sahlmann_search_2011} identified several candidate brown dwarf companions of FGK stars with \(\rm M_2 \sin{i}\) values >\(\rm 10~M_{Jup}\).  Seven candidates were selected for observation in order to identify their stellar nature. The target host stars are presented in Table~\ref{tab:starparams} with their stellar parameters, while the companion orbital parameters are provided in Table~\ref{tab:orbitparams}.
...
K-band spectra were obtained with the goal to achieve a direct detection of the companion spectra through the application of a spectral-differential approach. Doing so would enable a further constraint to be placed on their masses. The K-band is used to achieve a high contrast relative to the host star, detected in the extreme V-K color indexes (>7.8). 
...
\end{table*}
	...
	\begin{table*}
		...
		{HD 211847} 	 & 6.689\tablefootmark{a} & 7929.4 & 2500  		    	 & 0.685 & 0.068   	  & 291.4   & 12.2   & 12030.1    & 2500   & 159.2 		& 2.0     & 19.2  & 155  				& 3, 7\\
...
\begin{table*}
    ...
    \begin{tabular}{l c c c c c c c c}
        ...
        {HD 162020}   & \(7\times10^{-7} \)   & 1615  &  -98.92\tablefootmark{a} &  2344.24     & 0.28~~  \\  %
        {HD 167665}    & \(2\times10^{-4} \)   &  105    &  -14.47\tablefootmark{a}   &   138.45     & 0.18~~  \\  %  -- \(2\times10^{-5} \)  best case based on age rage.
        {HD 168443b} & \(1\times10^{-16} \)  &    \(1\times10^{8} \)   &  -64.65\tablefootmark{a} &   257.16   & 0.035 \\ 
        {HD 168443c} &  \(1\times10^{-11} \)  &   \(4\times10^{5} \)     &  -18.05\tablefootmark{a}  &   0.95   &  0.001 \\  %(c)
...
\begin{table*}
    ...
    \begin{tabular}{l c c c c r@{.}l r@{.}l r@{.}l}
        ...
        \midrule
        {HD 4747}   & 1 & 2012-07-06 07:36:06 & Ks     	      & 1.25  	  & $-$0    & 219 & $-$0  & 154 & 0&065 \\ %-1      & 2456114.81674
        {HD 162020} & 1 & 2012-07-04 06:23:22 & Ks     		& 1.30 		& $-$28  & 760 & 50 & 785\tablefootmark{a} & 79&545\tablefootmark{a} \\ %-1      & 2456112.76624
        {HD 162020} & 2 & 2012-07-04 06:57:48 & Ks     		& 1.44  	& $-$28  & 717 & 48 & 440\tablefootmark{a} & 77&157\tablefootmark{a} \\ %-2      & 2456112.79015
        {HD 167665} & 1 & 2012-07-28 05:00:53 & Hx5e-2 	& 1.24 		& 7         & 581 & 18 & 024\tablefootmark{a} & 10&443\tablefootmark{a} \\ %-1a     & 2456136.70895
        {HD 167665} & 2 & 2012-07-28 05:37:27 & Hx5e-2 	& 1.39  	& 7         & 581 & 18 & 025\tablefootmark{a}  & 10&444\tablefootmark{a} \\ %-1b     & 2456136.73434
        {HD 167665} & 3 & 2012-08-05 02:54:03 & Hx5e-2 	& 1.04  	& 7         & 575 & 18 & 163\tablefootmark{a} & 10&588\tablefootmark{a} \\ %-2      & 2456144.62087
        {HD 168443} & 1 & 2012-08-05 04:29:32 & Ks     		& 1.31 		& $-$0   & 121 & 50 & 932\tablefootmark{a, b}  & 51&053\tablefootmark{a,b} \\ %-1      & 2456144.68718
        {HD 168443} & 2 & 2012-08-05 04:58:50 & Ks     		& 1.47 		& $-$0   & 121 & 51 & 189 \tablefootmark{a, b} & 51&310\tablefootmark{a,b} \\ %-2      & 2456144.70753
        {HD 202206} & 1 & 2012-07-12 06:54:44 & Ks     		& 1.01 		& 14      & 843 & 12 & 992\tablefootmark{b}  & -1&851 \\ %-1      & 2456120.78801
        {HD 202206} & 2 & 2012-07-13 05:41:40 & J       		  & 1.01 	  & 14      & 837 & 13 & 065\tablefootmark{b}  & -1&772 \\ %-2      & 2456121.73727
        {HD 202206} & 3 & 2012-07-11 08:29:55 & Ks     		& 1.15		& 14      & 849 & 12 & 920\tablefootmark{b}  & -1&929 \\ %-3      & 2456119.85411
        {HD 211847} & 1 & 2012-07-06 07:02:57 & Ks     		& 1.07 		& 6        & 613 & 7   & 171 & 0& 558\\ %-1      & 2456114.79372
        {HD 211847} & 2 & 2012-07-13 06:54:37 & Ks     		& 1.05 		& 6        & 614 & 7   & 167 & 0&553 \\ %-2      & 2456121.78793
        {HD 30501}  & 1 & 2012-04-07 00:08:29 & Hx5e-2 	 & 1.60 	 & 22      &  372 & 36 & 377 & 14&005 \\ %-1      & 2456024.50590
        {HD 30501}  & 2 & 2012-08-01 09:17:30 & Hx5e-2    & 1.42		 & 22      & 505 & 35  & 120 & 12&615 \\ %-2a     & 2456140.88716
        {HD 30501}  & 3 & 2012-08-02 08:47:30 & Hx5e-2 	 & 1.53 	 & 22      & 507 &  35 & 102 & 12&595 \\ %-3      & 2456141.86633
        {HD 30501}  & 4 & 2012-08-06 09:42:07 & Ks     		 & 1.28 	 & 22      & 514 & 35 & 031 & 12&517 \\ %-2b     & 2456145.90426
        \bottomrule
...
\begin{table*}
    ...
    \begin{tabular}{c | *3c | *3c | *3c}
        ...
        \(T_{\textrm{eff}_2}\) & 4000 & - & 3800 & 3200 & - & 3100 & \(\sim3200\) & - & >3800\tablefootmark{a}\\
        \({rv}_1\) & 0 & 0.1 & 0 & 6.6 & 6.6 & 6.6 & \(6.6 \pm 0.3\) & 7& 7.6 \\
        \({rv}_2\) &  10 & - & 9.8 & 0.5 & - &  -1& \(0.5 \pm 2\) & - &-12.6\\
        \midrule
        \(R_1/R_2\)& 2.57 & - & 2.71& 3.16 & - & 3.27 & 3.16 & - & <2.71\tablefootmark{a}\\
        \(\rm F_2/F_1\)& 0.084 & - & 0.066 & 0.030 & - & 0.026 & 0.030 & -  & >0.066\tablefootmark{a}\\
        \(\chi^2\)& - & 4978 & 3792 & - & 3746 & 3630  & - & 37688 & 33860\\
        \(\chi^2_{red}\) & - & 1.62 & 1.24 & - & 1.22 & 1.18 & - & 21.3 & 19.2\\
        \bottomrule
    \end{tabular}
    \tablefoot{
        \tablefoottext{a}{At the arbitrary upper limit for companion temperature grid (3800~K).}
    }
...
\begin{table}
    ...
    \begin{tabular}{l c c c}
       ...
       {HD 30501}   & 3800\tablefootmark{a} & 0.106 & 560\\
       \bottomrule
    \end{tabular}
   \tablefoot{
       \tablefoottext{a}{From observed spectra}
    }
...
\begin{table}
    ...
    \end{tabular}
    \tablefoot{
        \tablefoottext{a}{avg. depth \(\times~ \rm F_2 / (F_1 + F_2)\), where \(F_1\) is the component in the far right column.}
        \tablefoottext{b}{avg. depth \(\times~ \rm F_1 / (F_1 + F_2)\), where \(\rm F_2\) is for the companion with \(T_{\textrm{eff}}\)=3200, logg=4.5.}
    }
...
%\bibliography{nir-bibliography.bib,myzotero.bib}
\bibliography{nir-paper}
